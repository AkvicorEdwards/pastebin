/* PrismJS 1.19.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+c+csharp+cpp+dart+docker+go+haskell+ini+java+json+kotlin+latex+lua+makefile+markdown+markup-templating+matlab+nginx+php+powershell+python+r+regex+scala+sql+swift+vim+wasm+yaml&plugins=line-highlight+line-numbers+remove-initial-line-feed+toolbar+copy-to-clipboard */
